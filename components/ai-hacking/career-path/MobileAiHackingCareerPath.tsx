...
type MobileAiHackingCareerPathProps = {
...
export function MobileAiHackingCareerPath({ showScrollTop }: MobileAiHackingCareerPathProps) {
  const router = useRouter();
  ...
  return (
    <div className="min-h-screen" style={{ background: "#090d14", color: "rgba(226,232,240,0.9)" }}>
      ...
      <div className="px-6 pt-16 pb-14 border-b border-white/5">
        ...
        >
          AI Hacking:<br />
          <span style={{ color: "rgba(249,115,22,0.95)" }}>The Career Path</span>
        </h1>
        <p className="text-lg leading-relaxed max-w-xl" style={{ color: "rgba(226,232,240,0.8)" }}>
          In 2026, we don&apos;t just &quot;chat&quot; with AI. We probe its architecture, intercept its traffic, and automate its failure. This roadmap covers everything from prompt engineering to adversarial ML research.
        </p>
          ...
          <section key={level.num} id={`level-${level.num}`} className="py-20 border-b border-white/5 last:border-0">
            ...
            <div className="mb-14">
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <span className="w-full font-mono text-[10px] uppercase tracking-widest mb-1 opacity-50">Exploitation Toolkit:</span>
