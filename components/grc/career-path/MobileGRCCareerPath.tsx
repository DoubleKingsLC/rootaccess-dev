...
export function MobileGRCCareerPath({ showScrollTop }: MobileGRCCareerPathProps) {
  const router = useRouter();
  ...
  return (
    <div className="min-h-screen" style={{ background: "#020f14", color: "rgba(226,232,240,0.9)" }}>
      ...
      <div className="px-6 pt-16 pb-14 border-b border-white/5">
        <p className="font-mono text-[11px] uppercase tracking-[0.5em] mb-6 font-bold" style={{ color: "#14b8a6" }}>
          GRC Roadmap
        </p>
        <h1
        ...
        >
          Governance & Risk:<br />
          <span style={{ color: "#14b8a6" }}>The Path Explained</span>
        </h1>
        <p className="text-lg leading-relaxed max-w-xl" style={{ color: "rgba(226,232,240,0.8)" }}>
          From foundational compliance to steering corporate strategy. This roadmap tracks your evolution across the GRC landscape.
        </p>
