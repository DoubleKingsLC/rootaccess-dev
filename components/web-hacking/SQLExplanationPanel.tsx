...
export const SQLExplanationPanel: React.FC<SQLExplanationPanelProps> = ({ localProgress }) => {
  ...
  return (
    <div
      className="pointer-events-none absolute z-[60] flex flex-col gap-4 lg:gap-6"
      style={{
    ...
    >
      ...
      <div className="space-y-2 lg:space-y-2.5">
        <div className="flex items-center gap-2">
          <div className="h-2 w-2 lg:h-2.5 lg:w-2.5 rounded-full bg-emerald-500 animate-pulse" />
          <p className="font-mono text-[10px] lg:text-[11px] uppercase tracking-[0.3em] lg:tracking-[0.4em] text-emerald-400/80">
            Why It Worked
          </p>
        </div>
        <h3 className="font-mono text-base lg:text-lg font-black uppercase tracking-[0.1em] lg:tracking-[0.15em] text-white leading-tight">
          SQL INJECTION<br />
      ...
      {/* Explanation steps */}
      <div className="flex flex-col gap-4 lg:gap-5 border-l-2 border-emerald-500/20 pl-4 lg:pl-6">
        <div className="space-y-1.5 lg:space-y-2">
          <p className="font-mono text-[9px] lg:text-[11px] font-bold uppercase tracking-[0.2em] lg:tracking-[0.3em] text-emerald-400">
            1. The Input
          </p>
          <p className="font-sans text-xs lg:text-[15px] leading-relaxed text-slate-300">
