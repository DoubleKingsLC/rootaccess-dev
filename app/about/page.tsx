...
const FOUNDERS = [
    {
        ...
        color: "#1db6ce",
        story:
            "Aaron is a cybersecurity professional with hands-on SOC operations experience including managing SOC operations for a large-scale Government of India deployment. A security engineer with expertise in endpoint forensics, threat hunting, threat intel and cloud forensics ,currently pursuing an MSc in Adaptive Cybersecurity at the University of Galway. Having aquired 3 certifications in the span of 3 months there is no stopping him. He has a passion for providing guidance and mentorship. Feel free to connect and reach out",
        skills: [
